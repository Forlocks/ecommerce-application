...
const LoginPage: React.FC = () => (
	<div className="login_page">
		<div className="form_container">
            ...
            <span>Welcome to our boutique of elegance,
                where unique designer vases await to add an artistic touch to your cherished spaces.
                 Sign in to explore our exclusive collection and bring
                 the essence of style into your home</span>
			<LoginForm />
		</div>
